//MAX30100 
//http://arduino.esp8266.com/stable/package_esp8266com_index.json  board install
...
const char* ssid = "aritra";  // Enter SSID here
...
void loop() {
  ...
  if (millis() - tsLastReport > REPORTING_PERIOD_MS) {
    ...
    SpO2 = pox.getSpO2();
    temp = analogRead(A0);
    temp = temp * 0.322265625; // for esp8266
...
String SendHTML(float BPM, float SpO2, float temp) {
  ...
  ptr += "<h1>Patient Health Monitor SYSTEM</h1>";    
  ptr += "<h1>CAREIFY</h1>";
